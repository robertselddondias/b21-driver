...
class HomeScreen extends StatelessWidget {
            ...
            body: controller.hasError.value
                ...
                : Column(
                    children: [
                      ...
                      _buildHeader(
                          context, controller, themeChange, isDarkMode),
                              ...
                              AnimatedSwitcher(
                                ...
                                child: controller.selectedIndex.value == 0
                                    ? _buildDriverStatusCard(context,
                                        controller, themeChange, isDarkMode)
  ...
  Widget _buildErrorState(BuildContext context, HomeController controller,
      DarkThemeProvider themeChange, bool isDarkMode) {
    return Container(
      color: AppColors.getBackgroundColor(isDarkMode),
      child: Center(
        child: Padding(
  ...
  Widget _buildDriverStatusCard(BuildContext context, HomeController controller,
      DarkThemeProvider themeChange, bool isDarkMode) {
    if (!controller.autoAssignmentController.isOnline.value) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: AppColors.getBorderColor(isDarkMode).withValues(alpha: 0.3),
            width: 1,
          ),
        ),
        child: Column(
  ...
  Widget _buildCompletedRidesCard(
  ...
  Widget _buildModernStatCard({
    ...
    return Container(
      height: Responsive.height(14.5, context), // Aumentado de 13 para 14.5
      decoration: BoxDecoration(
        gradient: gradient,
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            ...
            // Conteúdo
            Padding(
              padding: EdgeInsets.all(Responsive.width(3, context)), // Reduzido de 3.5 para 3
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                mainAxisSize: MainAxisSize.min,
                children: [
                  Container(
                    padding: EdgeInsets.all(Responsive.width(1.8, context)), // Reduzido de 2 para 1.8
                    decoration: BoxDecoration(
                    ...
                    child: Icon(
                      icon,
                      color: Colors.white,
                      size: Responsive.width(4.5, context), // Reduzido de 5 para 4.5
                    ),
                  ),
                  SizedBox(height: Responsive.height(1.5, context)), // Reduzido de 2 para 1.5
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Text(
                        value,
                        style: GoogleFonts.poppins(
                          fontSize: Responsive.width(4.8, context), // Reduzido de 5 para 4.8
                          fontWeight: FontWeight.w800,
                          color: Colors.white,
                          letterSpacing: -0.5,
                          height: 1.1, // Controla altura da linha
                        ),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                      SizedBox(height: Responsive.height(0.2, context)), // Reduzido de 0.3 para 0.2
                      Text(
                        label,
                        style: GoogleFonts.poppins(
                          fontSize: Responsive.width(3.2, context), // Reduzido de 3.5 para 3.2
  ...
  Widget _buildBottomNavigation(BuildContext context, HomeController controller,
      DarkThemeProvider themeChange, bool isDarkMode) {
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: isDarkMode
              ? [
                  AppColors.getContainerColor(isDarkMode).withValues(alpha: 0.95),
        ...
        border: Border(
          top: BorderSide(
            color: AppColors.getBorderColor(isDarkMode).withValues(alpha: 0.5),
            width: 1,
          ),
        ),
        boxShadow: [
      ...
      child: ClipRRect(
        child: BackdropFilter(
          ...
          child: BottomNavigationBar(
            ...
            currentIndex:
                controller.isValidIndex ? controller.selectedIndex.value : 0,
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        gradient: isSelected
            ? LinearGradient(
                colors: [
                  AppColors.getPrimaryColor(isDarkMode).withValues(alpha: 0.2),
