                      ...
                      double.parse(controller.driverModel.value.walletAmount.toString()) >= double.parse(Constant.minimumDepositToRideAccept)
                          ...
                          : SizedBox(
                              ...
                              child: Padding(
                                ...
                                child: Text("Você tem que ter no mínimo ${Constant.amountShow(amount: Constant.minimumDepositToRideAccept.toString())} valor da carteira para aceitar o pedido e fazer um lance".tr,
