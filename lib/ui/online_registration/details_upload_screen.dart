                            ...
                            child: Column(
                              children: [
                                Padding(
                                  ...
                                  child: controller.formatter.value != null ? TextFieldThem.buildTextMask(context,
                                      inputMaskFormatter: controller.cnhMaskFormatter,
                                      hintText: controller.documentModel.value.title.toString(), controller: controller.documentNumberController.value, keyBoardType: TextInputType.number)
                                      : TextFieldThem.buildTextFiled(context, hintText: "${controller.documentModel.value.title.toString()} número", controller: controller.documentNumberController.value, keyBoardType: TextInputType.text)
                                ),
                                Visibility(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Padding(
                                      ...
                                      child: TextFieldThem.buildTextFiledWithSuffixIcon(context,
                                          hintText: "Informe a data de Expiração".tr, controller: controller.expireAtController.value, enable: false, suffixIcon: Icon(Icons.calendar_month)),
                                    ),
                                  ),
                                ),
                                const SizedBox(
                                ...
                                Visibility(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text("Frente ${controller.documentModel.value.title.toString()}".tr, style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600)),
                                        const SizedBox(
                                          height: 10,
                                        ),
                                ...
                                Visibility(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Verso ${controller.documentModel.value.title.toString()}".tr, style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600)),
                                        const SizedBox(
                                          height: 10,
                                        ),
